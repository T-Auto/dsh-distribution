...
| LOD-01..03 | lodgement（proposal + JSON Schema 2020-12） | 已固化 fixtures + automated semantic tests（[lodgement fixtures](fixtures/lodgement.json)） | 真实载体位置、原子文件系统事务、持久全局唯一 registry，not-tested |
